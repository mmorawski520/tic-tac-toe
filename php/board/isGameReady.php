...
$whoCanMove = mysqli_fetch_assoc(mysqli_query($connection, "SELECT can_move,sign,player_type FROM games INNER JOIN players ON games.id=players.game_id WHERE player_ip='$playerIp'"));
